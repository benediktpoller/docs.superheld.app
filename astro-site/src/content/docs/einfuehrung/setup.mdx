...
:::note
Alle Einstellungen lassen sich jederzeit unter **Einstellungen** anpassen. Für erweiterte Optionen siehe [Konfiguration (Expert Mode)](/experten/konfiguration).
:::

---

## Nächster Schritt: [Tägliche Nutzung →](/einfuehrung/nutzung)

...
When the [Context Risk Engine](/experts/spec/context-risk-engine) correlates multiple signals, it produces a compound risk score that supersedes individual confidence scores. The compound score uses multiplicative combination, not additive.
...
- [Context Risk Engine](/experts/spec/context-risk-engine) — Compound risk scoring from multiple detections

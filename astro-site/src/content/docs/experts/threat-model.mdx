...
> `TODO-ENG-046`: Klären, ob ein Deepfake-Erkennungsmodell im Device Agent existiert und ob Audio-Zugriff erfolgt. Falls nicht: Kategorie als „geplant" markieren. Siehe [Privacy Model](/experts/spec/privacy-model).

...
4. **Server speichert verschlüsselt**
...
6. **Nachricht lesen und antworten**
...
<details>
<summary>Klick für Details: Risiken und Schutzmaßnahmen</summary>
...
- [Installation und Grundlagen](/getting-started/installation)
- [Sichere Nutzung unterwegs](/getting-started/usage)
- [Erweiterte Sicherheits-Konfiguration](/experts/configuration)
- [FAQ: Häufige Sicherheits-Fragen](/getting-started/faq)

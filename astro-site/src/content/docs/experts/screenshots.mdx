...
|---------|----------|--------|
| **Willkommens-Wizard** | Schnelle Einrichtung | Verfügbar |
| **Dashboard** | Tägliche Überwachung | Verfügbar |
| **Workflow-Editor** | Komplexe Automatisierung | Verfügbar |
| **Activity Log** | Fehlersuche | Verfügbar |
| **Team Sharing** | Zusammenarbeit | Verfügbar |
| **Mobile App** | Unterwegs | Verfügbar |
| **Integrationen** | Drittanbieter-Tools | Verfügbar |
| **API Access** | Custom Automation | Verfügbar |

---

## Welche Seite passt zu mir?

- **Anfänger?** → [Installation](/getting-started/installation) & [Setup](/getting-started/setup)
- **Täglich nutzen?** → [Nutzung](/getting-started/usage)
- **Profi-Workflows?** → [Konfiguration](/experts/configuration)
- **Fragen?** → [FAQ](/getting-started/faq)

---

**Bereit zu starten?** [Jetzt Installation durchgehen →](/getting-started/installation)

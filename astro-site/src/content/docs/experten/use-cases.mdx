...
:::note
- [Installation](/einfuehrung/installation-v2) – Schnell starten
- [Konfiguration](/experten/konfiguration) – Alles anpassen
- [Sicherheit](/experten/privacy-sicherheit) – Technische Details
- [FAQ](/einfuehrung/faq) – Häufige Fragen
:::

---

**Bereit?** [Installation →](/einfuehrung/installation-v2)

...
```
1. Öffne App Store
2. Suche "superheld.app"
3. Tippe "Get" / "Laden"
4. Authentifiziere mit Face ID / Touch ID
5. Warte auf Installation ✅
```

{{< button href="https://apps.apple.com/de/app/superheld-app/id123456789" >}}Im App Store öffnen{{< /button >}}
...
2. Suche "superheld.app"
3. Tippe "Install"
4. Bestätige Berechtigungen
5. Warte auf Download & Installation ✅
```

{{< button href="https://play.google.com/store/apps/details?id=app.superheld" >}}Im Play Store öffnen{{< /button >}}
...
1. Lade DMG herunter
2. Öffne DMG-Datei
3. Ziehe superheld-app ins Applications Folder
4. Starte aus Applications ✅
```

**Windows:**
```
1. Lade EXE-Installer herunter
2. Starte Installer
3. Folge den Anweisungen
4. App wird automatisch installiert ✅
```

{{< button href="https://downloads.superheld.app" >}}Desktop-Downloads{{< /button >}}
...
```
1. Gehe zu https://app.superheld.app
2. Klick "Get Started"
3. Erstelle Konto oder melde dich an
...
{{% expand title="Setup-Wizard starten (empfohlen)" %}}

Nach der Installation:

```
1. Starte superheld.app
2. Tippe "Konfigurieren"
3. Folge dem 5-Schritte Setup:
   ✅ Sprache wählen
   ✅ Passwort setzen
...
{{% expand title="Biometric Lock Setup" %}}
...
Auf iPad:
1. Same Apple ID Konto
2. Sync startet automatisch
3. Alle Daten sofort da ✅
```

{{% /tab %}}

{{% tab title="iPhone + Android" %}}

```
Auf iPhone:
1. Settings → Backup
2. "Manual Cloud Backup"
3. Tippe "Backup Now"

Auf Android:
1. Settings → Accounts
2. Füge gleichen Account hinzu
3. "Sync files from backup"
4. Restore startet automatisch ✅
```

{{% /tab %}}

{{% tab title="Alle Geräte" %}}

```
Universal-Methode (überall):
1. Settings → Account
2. Klick "Device Management"
3. Neue Geräte siehe "Pending Devices"
4. Bestätige auf neuem Gerät
...
{{% expand title="Installation fehlgeschlagen?" %}}
